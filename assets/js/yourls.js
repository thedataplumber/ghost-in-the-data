$(function() {
  ...
  $("body").on("click", ".share-link", function() {
    var $link = $(this);
    var params = {signature: "cbf987fac5", action: "shorturl", format: "json", url: $link.data('url')};
    $.getJSON("http://dat.pm/yourls-api.php", params, function(data) {
...
/*
function short( url){
  var api_url  = 'http://dat.pm/yourls-api.php';
  var response = $.get( api_url, {
      signature: "cbf987fac5",
      action:   "shorturl",
      format:   "json",
